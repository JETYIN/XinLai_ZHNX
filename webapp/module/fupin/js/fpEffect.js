	...
	center.prototype = $.extend({}, zhnx.chartInit, {
		...
		initPage0 : function(areaCode){
			...
			this.drawMapArea({
				...
				mapName: "NX",
				url: "poverty/effect/getShiErWuAntPoverty.do",
				operable: false
			}, {
		...
		initPage0ExceptMap : function(areaCode){
			...
			this.drawLineChart("widget0_0", {
				url: "poverty/effect/getShiErWuAntPovertyBar0.do"
			}, {
				title : "宁夏全区贫困人口",
				commandLegendClick: function(commandArgs){
					var command = $.extend({
			...
			this.drawLineChart("widget0_1", {
				url: "poverty/effect/getShiErWuAntPovertyBar1.do"
			}, {
				title : "宁夏全区贫困村",
				commandLegendClick: function(commandArgs){
					var command = $.extend({
			...
			this.drawLineChart("widget0_2", {
				url: "poverty/effect/getShiErWuAntPovertyBar2.do"
			}, {
				title : "宁夏全区贫困户",
				commandLegendClick: function(commandArgs){
					var command = $.extend({
			...
			this.drawLineChart("widget0_3", {
				url: "poverty/effect/getShiErWuAntPovertyBar3.do"
			}, {
				title : "宁夏全区人均可支配收入",
				commandLegendClick: function(commandArgs){
					var command = $.extend({
		...
		initPage1 : function(areaCode){
			...
			this.drawMapArea({
				drawType: "Migration",
				mapName: "NX",
				url: "poverty/effect/getMigration.do",
				operable: false
			}, {
				commandLegendClick: function(commandArgs){
					var command = $.extend({
		...
		initPage1ExceptMap : function(areaCode){
			...
			this.drawQianchuInfo("widget1_0", {
				url: "poverty/effect/getMigrationBar0.do"
			}, {
				title : "迁出",
				mode : "left",
			...
			this.drawQianRuInfo("widget1_1", {
				url: "poverty/effect/getMigrationBar1.do"
			}, {
				title : "迁入",
				mode : "right",
				navOuterClick: function(i, areaCode){
		...
		initPage2 : function(areaCode){
			...
			this.drawMapArea({
				drawType: "Description",
				mapName: "XHG",
				url: "poverty/effect/getXHGEconomic.do",
				operable: false
			},{
				commandLegendClick: function(commandArgs){
					var command = $.extend({
		...
		initPage2ExceptMap : function(areaCode){
			...
			this.drawfpAreaChart("widget2_0", {
				url: "poverty/effect/getXHGEconomicBar0.do"
			}, {
				title : "西海固地区生产总值",
				series : {
					mode : "sm"
			...
			this.drawAreaChart("widget2_1", {
				url: "poverty/effect/getXHGEconomicBar1.do"
			}, {
				title : "西海固地方财政收入和支出",
				series : {
					mode : "mm"
			...
			this.drawAreaChart("widget2_2", {
				url: "poverty/effect/getXHGEconomicBar2.do"
			}, {
		...
		initPage3ExceptMap : function(areaCode){
			...
			this.drawAreaChart("widget3_0", {
				url: "poverty/effect/getXHGPopulationBar0.do"
			}, {
				title : "西海固地区绝对贫困人口",
				commandNavClick: function(commandArgs){
					var command = $.extend({
			...
			this.drawAreaChart("widget3_1", {
				url: "poverty/effect/getXHGPopulationBar1.do"
			}, {
			...
			this.drawAreaChart("widget3_2", {
				url: "poverty/effect/getXHGPopulationBar2.do"
			}, {
		...
		initPage4 : function(areaCode){
			...
			this.drawMapArea({
				drawType: "Description",
				mapName: "NX",
				url: "poverty/effect/getMigrantWorkers.do"
			},{
				click: function(areaCode){
					zhnx.centerObj.initPage4ExceptMap(areaCode);
				},
				dbclick: function(areaCode){
					zhnx.centerObj.initPage4ExceptMap(areaCode);
				},
				legendClick: function(i){
					zhnx.centerObj.getComponent("widget4_1").navClick(i);
//					zhnx.centerObj.getComponent("widget4_2").navClick(i);
				},
...
//			this.drawfpMixtureArea("widget4_0", {
//				url: "poverty/effect/getMigrantWorkersLine.do",
...
//			});
			...
			this.drawTriangleChartDetail("widget4_1", {
				url:"poverty/effect/getMigrantWorkersBar0.do",
				data:{areaCode: cityLocation.code}
			}, areaCode, {
...
//			this.drawTriangleChartDetail("widget4_2", {
//				url:"poverty/effect/getMigrantWorkersBar1.do",
//				data:{areaCode: cityLocation.code}
//			}, areaCode, {
//				title : areaName + "务工人员可支配收入",
//				unit : "千元",
//				commandNavClick: function(commandArgs){
//					var command = $.extend({
//						level: 4,
...
//			});
		...
		initPage5 : function(areaCode){
			...
			this.drawMapArea({
				drawType: "Description",
				mapName: "NX",
				url: "poverty/effect/getOtherHelp.do",
				operable: false
			},{
				click: function(areaCode){
				...
				legendClick: function(i){
					zhnx.centerObj.getComponent("widget5_1").navClick(i);
				},
				commandLegendClick: function(commandArgs){
					var command = $.extend({
						level: 3,
		...
		initPage5ExceptMap : function(areaCode){
			...
			this.drawPetalChart("widget5_0", {
				url:"poverty/effect/getOtherHelpSum.do",
				data:{areaCode: cityLocation.code}
			}, {
			...
			this.drawTriangleChartDetail("widget5_1", {
				url:"poverty/effect/getOtherHelpBar.do",
				data:{areaCode: cityLocation.code}
			}, areaCode, {
		...
		initPage6 : function(areaCode){
			...
			this.drawMapArea({
				drawType: "Description",
				mapName: "NX",
				url: "poverty/effect/getPrecise.do",
				operable: false
			},{
				click: function(areaCode){
//					zhnx.centerObj.initPage6ExceptMap(areaCode);
				},
				dbclick: function(areaCode){
//					zhnx.centerObj.initPage6ExceptMap(areaCode);
				},
				legendClick: function(i){
					zhnx.centerObj.getComponent("widget6_1").navClick(i);
				},
//				commandClick: function(commandArgs){
//					var command = $.extend({
//						level: 3,
...
//				},
		...
		initPage6ExceptMap : function(areaCode){
			...
			this.drawPetalChart("widget6_0", {
				url:"poverty/effect/getPreciseSum.do",
				data:{areaCode: cityLocation.code}
			},{
			...
			this.drawTriangleChartDetail("widget6_1", {
				url:"poverty/effect/getPreciseBar.do",
				data:{areaCode: cityLocation.code}
			}, areaCode, {
				commandNavClick: function(commandArgs){
					var command = $.extend({
		...
		initPage7 : function(areaCode){
			...
			this.drawMapArea({
				drawType: "Description",
				mapName: "NX",
				url: "poverty/effect/getToFamily.do",
				operable: false
			},{
				click: function(areaCode){
//					zhnx.centerObj.initPage7ExceptMap(areaCode);
				},
				dbclick: function(areaCode){
//					zhnx.centerObj.initPage7ExceptMap(areaCode);
				},
				legendClick: function(i){
					zhnx.centerObj.getComponent("widget7_1").navClick(i);
				},
//				commandClick: function(commandArgs){
//					var command = $.extend({
//						level: 3,
...
//				},
		...
		initPage7ExceptMap : function(areaCode){
			...
			this.drawfphorizonColumn("widget7_0", {
				url:"poverty/effect/getToFamilyBar0.do",
				data:{areaCode: cityLocation.code}
			}, {
			...
			this.drawTriangleChartDetail("widget7_1", {
				url:"poverty/effect/getToFamilyBar1.do",
				data:{areaCode: cityLocation.code}
			}, areaCode, {
				commandNavClick: function(commandArgs){
					var command = $.extend({
...
//console.log(ajaxArgs)
		...
		//地图区域
		drawMapArea: function(chartargs, funcObj){
			var temp = $.extend({}, chartargs, funcObj);
			if(chartargs.drawType == "Migration"){
				temp = $.extend({}, temp, {
					moveIn: "640104000000",
					moveOut: "640324000000",
				});
			}
			this.drawMap("widgetMap", { }, temp, {});
		},
