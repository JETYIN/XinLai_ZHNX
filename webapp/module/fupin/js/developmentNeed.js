$(function() {
	...
	center.prototype = $.extend({}, zhnx.chartInit, {
		...
		initPage0 : function(){
			var that = this;
			this.clearPage();
			this.drawMapArea("Description", "NX", "poverty/development/getpovertyneed.do", {
				
					click: function(areaCode){
					that.changePageDetail(areaCode);
				},
		...
		initPage1: function(){
			var that = this;
			this.clearPage();
			this.drawMapArea("Description", "NX", "poverty/development/getindustryinfo.do", {
					click: function(areaCode){
					that.changePageDetail(areaCode);
				},
				dbclick: function(areaCode){
		...
		initPage2: function(){
			var that = this;
			this.clearPage();
			this.drawMapArea("Description", "NX", "poverty/development/getinformationinfo.do", {
					click: function(areaCode){
					that.changePageDetail(areaCode);
				},
				dbclick: function(areaCode){
		...
		initPage3: function(){
			var that = this;
			this.clearPage();
			this.drawMapArea("Description", "NX", "poverty/development/getabilityinfo.do", {
					click: function(areaCode){
					that.changePageDetail(areaCode);
				},
				dbclick: function(areaCode){
...
//					zhnx.centerObj.initPageWithoutMap3(areaCode);
		...
		initPage0ExceptMap : function(areaCode){
			...
			this.drawPetalChartDetail("widget0", {
				url:"poverty/development/getpovertyneedsum.do",
			...
			this.drawTriangleChartDetail("widget1", {
				url:"poverty/development/getpovertyneedbar.do",
				data:{areaCode: cityLocation.code}
			}, areaCode, {
					...
					if(countrycode.startWith("6400")){
						...
						if(countrycode.endWith("00000000")){
							...
							if(countrycode != undefined && countrycode != null){
								var cunURL = "poverty/development/getpovertyneedbar.do";
		...
		initPage1ExceptMap : function(areaCode){
			...
			this.drawCircleChartsDetail("widget0", {
				url:"poverty/development/getindustryinfosum.do",
				data:{areaCode: cityLocation.code}
			}, areaCode, {
				centerText : ['',''],
...
//				}
			...
			this.drawTriangleChartDetail("widget1", {
				url:"poverty/development/getindustryinfobar.do",
				data:{areaCode: cityLocation.code}
			}, areaCode, {
				dataClick: function(countrycode){
					if(countrycode.startWith("6400")){
						...
						if(countrycode.endWith("00000000")){
							...
							if(countrycode != undefined && countrycode != null){
								var cunURL = "poverty/development/getindustryinfobar.do";
								zhnx.centerObj.changePage(countrycode, cunURL);
							}
						}
					}
		...
		initPage2ExceptMap : function(areaCode){
			...
			var areaName = cityLocation.name;
			this.drawCircleChartsDetail("widget0", {
				url:"poverty/development/getinformationinfosum.do",
				data:{areaCode: cityLocation.code}
			}, areaCode, {
				centerImg : true,
				centerText : ['',''],
...
//				}
			...
			this.drawTriangleChartDetail("widget1", {
				url:"poverty/development/getinformationinfobar.do",
				data:{areaCode: cityLocation.code}
			}, areaCode, {
				dataClick: function(countrycode){
					if(countrycode.startWith("6400")){
						...
						if(countrycode.endWith("00000000")){
							...
							if(countrycode != undefined && countrycode != null){
								var cunURL = "poverty/development/getinformationinfobar.do";
								zhnx.centerObj.changePage(countrycode, cunURL);
							}
						}
					}
		...
		initPage3ExceptMap : function(areaCode){
			...
			var areaName = cityLocation.name;
			this.drawCircleChartsDetail("widget0", {
				url:"poverty/development/getabilityinfosum.do",
				data:{areaCode: cityLocation.code}
			}, areaCode, {
				centerText : ['计划培训','10'],
				unit : ["人","人"],
...
//				}
			...
			this.drawTriangleChartDetail("widget1", {
				url:"poverty/development/getabilityinfobar.do",
				data:{areaCode: cityLocation.code}
			}, areaCode, {
				dataClick: function(countrycode){
					if(countrycode.startWith("6400")){
						...
						if(countrycode.endWith("00000000")){
							...
							if(countrycode != undefined && countrycode != null){
								var cunURL = "poverty/development/getabilityinfobar.do";
								zhnx.centerObj.changePage(countrycode, cunURL);
							}
						}
					}
		...
		initPage4ExceptMap : function(areaCode){
			...
			this.drawCircleChartsDetail("widget0", {url:"poverty/development/getopeninfosum.do", data:areaCode}, areaCode, {
				centerText : ['"五通"','"八有"'],
			    unit : ["户","村"],
			    margin : 0,
			    innerLayer_1 : true,   
...
//				}
			...
			this.drawTriangleChartDetail("widget1", {
				url:"poverty/development/getopeninfo.do",
				data:areaCode
			}, areaCode, {
				dataClick: function(countrycode){
					if(countrycode.startWith("6400")){
						...
						if(countrycode.endWith("00000000")){
							...
							if(countrycode != undefined && countrycode != null){
								var cunURL = "poverty/development/getopeninfo.do";
								zhnx.centerObj.changePage(countrycode, cunURL);
							}
						}
					}
...
//				that.initTablePage0();		//整体情况
		...
		//地图区域
		drawMapArea: function(drawType, mapName, url, funcObj){
