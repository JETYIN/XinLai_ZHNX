$(function() {
	...
	center.prototype = $.extend({}, zhnx.chartInit, {
		constructor: center,
		selector: "#centerZone",
		pagePath: "module/health/regionalPlatform",
		...
		drawPopulationNumInit:function(widgetID){
			this.drawPopulation(widgetID, {
				url: "health/regionalPlatform/getPopulation.do"
				}, {
					dataList: {
		                type:"pupaliation",
		        	    title:"全区人口统计",
		...
		drawPopulationAndMedicalServiceInit:function(widgetID){
			this.drawPopulation(widgetID, {
				url: "health/regionalPlatform/getPopulationAndMedicalService.do"
			}, {
				dataList:{
		          type:"medical",
	        	  title:"医疗服务统计",
...
//				innerIcon:["dangAnJianDangShu","dangAnJianDangLv"],//页面1的图标
//				innerTopText:["（个）",""],//页面1的文字
//				innerValue:[6296179,93],
				
		        series:{
//		        	label:[["未完成建档","完成建档"],["高血压患者","糖尿病患者","老年人","0-6岁儿童","孕产妇","0-6岁儿童预防接种人数","重性精神病人"]],
		        	data:[
		        	      {
		        	    	  unit:"个",
		        	    	 data:[30000,21000],
